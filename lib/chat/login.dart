  ...
  return MaterialApp(
    ...
    home: Scaffold(
      resizeToAvoidBottomInset: false,//pixel hatası gitsin diye
        appBar: AppBar(
          title: const Text("BİLGİ ALIŞVERİŞİ",
...
child: Text("Giriş Yapınız",textAlign:TextAlign.center,
...
children: <Widget>[
  Image.network("https://w7.pngwing.com/pngs/492/370/png-transparent-hands-in-autism-child-asperger-syndrome-autistic-spectrum-disorders-child-glass-people-social-group.png",
  height: 200,),
